<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 UIP Kalbagtim <a href="http://www.pln.co.id">PT. PLN (Persero)</a>.</strong> All rights reserved.
</footer>
<!-- Bootstrap 3.3.5 -->
<script src="<?php echo base_url(); ?>asset/adminlte/bootstrap/js/bootstrap.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo base_url(); ?>asset/adminlte/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url(); ?>asset/adminlte/plugins/knob/jquery.knob.js"></script>
<!-- daterangepicker -->
...
<!-- datepicker -->
<script src="<?php echo base_url(); ?>asset/adminlte/plugins/datepicker/bootstrap-datepicker.js"></script>
<!-- bootstrap time picker -->
<script src="<?php echo base_url(); ?>asset/adminlte/plugins/timepicker/bootstrap-timepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
